...
<template>
  ...
  <div class="sliderWrapper flex no-scrollbar overflow-x-scroll relative mt-6 pb-14 pl-6">
    ...
    <ul class="sliderList flex flex-nowrap text-xs pr-6">
      ...
      <li v-if="loading" class="mr-3 relative w-56 sm:w-72"> 
        <article class="bg-custom-color-black rounded-xl shadow-lg shadow-custom-color-dark">
          <div class="relative">
            <figure class="aspect-w-16 aspect-h-9"></figure>
          </div>
          <div class="pl-3 pt-4 pb-1">
            <header>
              <h3 class="text-base text-custom-color-black sm:text-lg">Title</h3>
            </header>
            <footer class="text-center my-2">
              <div class="w-5 h-5 mt-1"></div>
              <div class="w-5 h-5 mt-1"></div>
              <div class="w-5 h-5 mt-1"></div>
            </footer>
            <div class="my-3 px-8 py-1 text-custom-color-black ">Infos</div>
          </div>
        </article>
      </li>

      <li v-for="activity of activities" :key="activity.id" class="mr-3 relative w-56 sm:w-72"> 
        <article class="bg-custom-color-dark rounded-xl shadow-lg shadow-custom-color-dark">
          ...
          <div class="relative">
            ...
            <span class="absolute bottom-3 right-3 font-bold">{{ activity.date }}</span>
          </div>
          ...
          <div class="pl-3 pt-4 pb-1">
            ...
            <footer class="text-center my-2">
              ...
              <div class="flex items-center mt-1">
                ...
                <p class="mr-2">{{ activity.user.pseudo }}</p>
