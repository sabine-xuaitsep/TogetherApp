    ...
    <footer id="navBar">
      <nav class="py-3 w-full bg-slate-50">
        <ul class="flex justify-around text-custom-color-black">
          ...
          <li>
            <router-link :to="{ name: '404', params: { type: 'profile' } }" class="flex items-center justify-center w-8 h-8">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
              <span class="sr-only">Profil</span>
            </router-link>
          </li>
          <li>
            <router-link :to="{ name: '404', params: { type: 'bookmarks' } }" class="flex items-center justify-center w-8 h-8">
          ...
          <li>
            <router-link :to="{ name: '404', params: { type: 'parameters' } }" class="flex items-center justify-center w-8 h-8">
